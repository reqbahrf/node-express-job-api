...
const Home = () => {
  return (
    <div className='min-h-screen flex flex-col bg-amber-50'>
      <div className='bg-sky-500 w-full h-[10vh] flex items-center justify-between px-3'>
      ...
      <div className='flex-1 flex flex-col md:flex-row items-center justify-center p-8 gap-8'>
        <div className='text-lg text-gray-600 max-w-2xl md:h-[25vh] flex items-center justify-center'>
        ...
        <div className='flex flex-col items-center justify-center space-y-4 w-full max-w-xs md:h-[25vh]'>
          <Link
            to='/login'
